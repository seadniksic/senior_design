...
// Wheel directions
#define FRFOR(PWM) AXIS_FORWARD_FLIPPED(FR_IN3_PIN, FR_IN4_PIN, PWM) //this is correct
#define FLFOR(PWM) AXIS_FORWARD(FL_IN1_PIN, FL_IN2_PIN, PWM) //this is correct
#define BRFOR(PWM) AXIS_FORWARD(BR_IN1_PIN, BR_IN2_PIN, PWM) //this is back left
#define BLFOR(PWM) AXIS_FORWARD_FLIPPED(BL_IN3_PIN, BL_IN4_PIN, PWM) //this is back right
#define FRBACK(PWM) AXIS_BACKWARD_FLIPPED(FR_IN3_PIN, FR_IN4_PIN, PWM)
#define FLBACK(PWM) AXIS_BACKWARD(FL_IN1_PIN, FL_IN2_PIN, PWM)
#define BRBACK(PWM) AXIS_BACKWARD(BR_IN1_PIN, BR_IN2_PIN, PWM)
