...
#define BRFOR(PWM) AXIS_FORWARD_FLIPPED(BR_IN1_PIN, BR_IN2_PIN, PWM) //this is back left
#define BLFOR(PWM) AXIS_FORWARD(BL_IN3_PIN, BL_IN4_PIN, PWM) //this is back right
...
#define BLBACK(PWM) AXIS_BACKWARD(BL_IN3_PIN, BL_IN4_PIN, PWM)
