...
class IMU_Data final: public ::EmbeddedProto::MessageInterface
{
  public:
    IMU_Data() = default;
    ...
    IMU_Data(const IMU_Data&& rhs ) noexcept
    {
      if(rhs.has_lia_x())
      {
        set_lia_x(rhs.get_lia_x());
    ...
    IMU_Data& operator=(const IMU_Data&& rhs) noexcept
    {
      if(rhs.has_lia_x())
      {
        set_lia_x(rhs.get_lia_x());
    ...
    inline void set_lia_x(const int32_t& value)
    {
      presence_[presence::index(presence::fields::LIA_X)] |= presence::mask(presence::fields::LIA_X);
      lia_x_ = value;
    }
    ...
    inline int32_t& mutable_lia_x()
    {
      presence_[presence::index(presence::fields::LIA_X)] |= presence::mask(presence::fields::LIA_X);
      return lia_x_.get();
    }
    inline const int32_t& get_lia_x() const { return lia_x_.get(); }
    inline int32_t lia_x() const { return lia_x_.get(); }
    ...
    inline void set_lia_y(const int32_t& value)
    {
      presence_[presence::index(presence::fields::LIA_Y)] |= presence::mask(presence::fields::LIA_Y);
      lia_y_ = value;
    }
    ...
    inline int32_t& mutable_lia_y()
    {
      presence_[presence::index(presence::fields::LIA_Y)] |= presence::mask(presence::fields::LIA_Y);
      return lia_y_.get();
    }
    inline const int32_t& get_lia_y() const { return lia_y_.get(); }
    inline int32_t lia_y() const { return lia_y_.get(); }
    ...
    inline void set_lia_z(const int32_t& value)
    {
      presence_[presence::index(presence::fields::LIA_Z)] |= presence::mask(presence::fields::LIA_Z);
      lia_z_ = value;
    }
    ...
    inline int32_t& mutable_lia_z()
    {
      presence_[presence::index(presence::fields::LIA_Z)] |= presence::mask(presence::fields::LIA_Z);
      return lia_z_.get();
    }
    inline const int32_t& get_lia_z() const { return lia_z_.get(); }
    inline int32_t lia_z() const { return lia_z_.get(); }
    ...
    inline void set_eul_y(const int32_t& value)
    {
      presence_[presence::index(presence::fields::EUL_Y)] |= presence::mask(presence::fields::EUL_Y);
      eul_y_ = value;
    }
    ...
    inline int32_t& mutable_eul_y()
    {
      presence_[presence::index(presence::fields::EUL_Y)] |= presence::mask(presence::fields::EUL_Y);
      return eul_y_.get();
    }
    inline const int32_t& get_eul_y() const { return eul_y_.get(); }
    inline int32_t eul_y() const { return eul_y_.get(); }
    ...
    inline void set_eul_p(const int32_t& value)
    {
      presence_[presence::index(presence::fields::EUL_P)] |= presence::mask(presence::fields::EUL_P);
      eul_p_ = value;
    }
    ...
    inline int32_t& mutable_eul_p()
    {
      presence_[presence::index(presence::fields::EUL_P)] |= presence::mask(presence::fields::EUL_P);
      return eul_p_.get();
    }
    inline const int32_t& get_eul_p() const { return eul_p_.get(); }
    inline int32_t eul_p() const { return eul_p_.get(); }
    ...
    inline void set_eul_r(const int32_t& value)
    {
      presence_[presence::index(presence::fields::EUL_R)] |= presence::mask(presence::fields::EUL_R);
      eul_r_ = value;
    }
    ...
    inline int32_t& mutable_eul_r()
    {
      presence_[presence::index(presence::fields::EUL_R)] |= presence::mask(presence::fields::EUL_R);
      return eul_r_.get();
    }
    inline const int32_t& get_eul_r() const { return eul_r_.get(); }
    inline int32_t eul_r() const { return eul_r_.get(); }
  ...
  private:
      ...
      struct presence
      {
        ...
        static constexpr uint32_t N_FIELDS = 6;
      ...
      EmbeddedProto::int32 lia_x_ = 0;
      EmbeddedProto::int32 lia_y_ = 0;
      EmbeddedProto::int32 lia_z_ = 0;
      EmbeddedProto::int32 eul_y_ = 0;
      EmbeddedProto::int32 eul_p_ = 0;
      EmbeddedProto::int32 eul_r_ = 0;
