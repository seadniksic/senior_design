...
"""autogenerated by genpy from rtabmap_ros/CameraModels.msg. Do not edit."""
import codecs
import sys
...
class CameraModels(genpy.Message):
  ...
  _type = "rtabmap_ros/CameraModels"
...
"""
  __slots__ = ['models']
  _slot_types = ['rtabmap_ros/CameraModel[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = rtabmap_ros.msg.CameraModel()
