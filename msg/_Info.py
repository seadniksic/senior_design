...
float64[36] information"""
  ...
  _slot_types = ['std_msgs/Header','int32','int32','int32','int32','geometry_msgs/Transform','int32[]','int32[]','float32[]','int32[]','float32[]','int32[]','float32[]','int32[]','int32[]','int32[]','string[]','string[]','float32[]','int32[]','int32','rtabmap_ros/MapGraph']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.odom_cache is None:
        self.odom_cache = rtabmap_ros.msg.MapGraph()
    else:
      self.header = std_msgs.msg.Header()
      self.refId = 0
      self.loopClosureId = 0
